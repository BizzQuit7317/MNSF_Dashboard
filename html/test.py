...
async def main():
    ...
    tasks.append(fetch_btc_node_price("bc1p5p8xqcl0lrxlf3kel2v4lqslf78kss2q8ct7gt08gvuuvvukqgps22dh7c", 0, "staking"))
    tasks.append(fetch_btc_node_price("bc1pl8trcu0ffhhh68gltjvgg8y637jeclnpqcq684f89mmkcslqq32qm0rf02", 0, "staking_2"))
    print("btc tasks apended")    

    # Polkadot / KSM tasks (the second argument '13' refers to Prices[13] for KSM)
    tasks.append(fetch_polkadot_balance('Ghacj2E4HSukpiKfnDCaEoMtiNLepM1Qbyy7YAaLXCbyfmb', 13, "staking"))
    tasks.append(fetch_polkadot_balance('Cik3FxLLH3FRgqQ3QhrWbwXxvbrpesRcs2xY5yJSYfCZGSw', 13, "staking_3"))
    tasks.append(fetch_polkadot_balance('CzZqQTsfNADsFLs71uv3nH6pn2meKD1bmzQBxANqArn38wt', 13, "staking_5"))
    tasks.append(fetch_polkadot_balance('EfKedUxGa2nYb4rbweJdjRas5pKej7YFy9s7iu48DE7eEhw', 13, "staking_2"))
    tasks.append(fetch_polkadot_balance('JJGMQu3ZXNTJUnR9bvC4dPBBKWYe5924KRWmC37Gi39N443', 13, "staking"))
    tasks.append(fetch_polkadot_balance('CusRg4TtuzTk383288KJH59qnTbJK9bJKnvRvSFaabkwErz', 13, "staking_2"))
    print("polkadot tasks appended") 

    # Cosmos example for ATOM – Prices[8]:
    tasks.append(fetch_cosmos_balance('cosmos1vzwe79zdjelepczsktulndgcfc6nug3gfq6u5z', 8, 'ATOM', 'FireBlocks', "staking"))
    # Cosmos Cold ATOM (if needed):
    tasks.append(fetch_cosmos_balance('cosmos14s26z3n4g3erzh9naw5arpkh8k7zqtntzvkz44', 8, 'ATOM', 'FireBlocks_Cold', "cold"))
    print("cosmos tasks appended")

    #SCRT
    tasks.append(fetch_cosmos_balance('secret1m5twqktzu626n8g7ppfl7d9kax50hqmyk43lc4', 10, 'SCRT', 'FireBlocks', "staking"))
    print("scrt tasks appeneded")

    #KAVA
    tasks.append(fetch_cosmos_kava_balance('kava1m5twqktzu626n8g7ppfl7d9kax50hqmyg93tnw', 9, 'KAVA', 'FireBlocks', "staking"))    
    print("kava tasks appended")

    # Cartesi CTSI example – Prices[2]:
    tasks.append(fetch_cartesi_balance('0x3c2de10E0E3d14aE12318441522b877A6e0a6539', "0x48381609a2f1bfe30b465e106bf8324342abe107", 2, 'FireBlocks', "staking"))
    tasks.append(fetch_cartesi_balance('0x8214437970a983089531df4B2BA67a666263c65E', "0x48381609a2f1bfe30b465e106bf8324342abe107", 2, 'FireBlocks_Cold', "cold"))
    print("ctsi tasks appended")    

    # Harmony ONE – Prices[12]:
    tasks.append(fetch_harmony_balance('one1fvvceuv6lzd0574858ct6w7qv6lp6g4x675zg0', 12))
    print("Harmony tasks appended")
    # Tezos examples – Prices[1]:
    tasks.append(fetch_tezos_balance('tz1YpmhK23nqduyYCnt7x9M8o8aWSuMb36tX', 1, 'FireBlocks', "staking"))
    tasks.append(fetch_tezos_balance('tz1hTjuQTyGhg12U1rDHRRn3TxdHdXiXcgNP', 1, 'FireBlocks_Cold', "cold"))
    print("Tezos tasks appended")
    # AVAX – Prices[11]:
    tasks.append(fetch_avax_balance('P-avax1vj47glgnjlytzh2nsc8g4fvtuh54et7vpmd2v9', '0x3c2de10E0E3d14aE12318441522b877A6e0a6539', 11))
    print("AVAX tasks appended")
    

    """
    # NEAR – Prices[5]:
    tasks.append(fetch_near_balance('9ee4fa4e5d4cb5c8eff5e45a3ce32241e280583a4240ea7f702ce523b5e2abc7', 5))
    print("NEAR tasks appended")
    """    


    # FLOW – Prices[14]:
    tasks.append(fetch_flow_balance('0x52aad21dcc281aa5', 14))
    print("FLOW tasks appended")
    # LPT examples – Prices[7]:
    tasks.append(fetch_lpt_balance("0x3c2de10E0E3d14aE12318441522b877A6e0a6539", 7, 'FireBlocks', "staking"))
    tasks.append(fetch_lpt_balance("0x8214437970a983089531df4B2BA67a666263c65E", 7, 'FireBlocks_Cold', "cold"))
    print("LPT tasks appended")
    # Oasis ROSE – Prices[3]:
    tasks.append(fetch_oasis_balance('oasis1qp2zelkjf5eljkd30leuf9lxsj8r9hs56s0u5rhu', 3))
    ...
    tasks.append(fetch_eth_balance("0x3c2de10E0E3d14aE12318441522b877A6e0a6539", 6, "staking"))
    tasks.append(fetch_eth_balance_m2("0x3c2de10E0E3d14aE12318441522b877A6e0a6539", 6, "available"))
