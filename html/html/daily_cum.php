...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	$gav_query = "python3 /home/ubuntu/tran_test/main/daily_gav.py";

	//echo $gav_query;

	$gav_output = '/tmp/gav_output.txt';
	shell_exec("$gav_query > $gav_output 2>&1");
	$o_output = file_get_contents($gav_output);
	...
	echo "<h2>Daily Gav Difference</h2>";
	...
	$query = "python3 /home/ubuntu/tran_test/main/second_main.py {$queryTime} {$queryDate_old} {$queryDate} rewards False COIN_REWARDS";
	...
	#$q2 = "python3 /home/ubuntu/tran_test/main/second_main.py {$queryTime} {$queryDate_old} {$queryDate} report False_Fund Total_Funding";
	$q2 = "python3 /home/ubuntu/tran_test/main/funding_24.py";
	...
	$q3 = "python3 /home/ubuntu/tran_test/main/breakdown.py";

	//echo "sudo " . $q3;

	//echo "<h2>Breakdown Constructor</h2>";

	$output_file = '/tmp/output_8.txt';
        shell_exec("$q3 > $output_file 2>&1");
	$output = file_get_contents($output_file);
